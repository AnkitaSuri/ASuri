...
// color selector
let correct = [97,110,107, 105,116,97];
let index = 0;
document.addEventListener("keypress", function(event){
  let num = event.keyCode
  if(correct[index]==num){
...
let activateColor = function(){
  window.alert("Color Selection Activated: Left click an area to set it's color. Refresh page to deactivate.");

  $("h1,h2,p,a,section, div").spectrum({
    // color: "#ECC",
    showInput: true,
    ...
    move: function (color) {
      ...
      if(e.is("h1")||e.is("h2")||e.is("p")||e.is("a")){
    ...
    palette: [
      "rgb(118, 50, 63);","rgb(86, 86, 86);","rgb(215, 206, 199);"
    ]
  });
}
